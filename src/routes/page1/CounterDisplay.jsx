...
const CounterDisplay = (props) => {
    ...
    const counter = useSelector(state => state.counters.counters).find(c => c.id === props.counterId)
    ...
    return (
        ...
        {user && <Link to={`/counters/edit/${props.counterId}?mode=edit`} className="btn btn-outline-light ms-auto"><i className="bi bi-pencil-square"></i></Link>}
